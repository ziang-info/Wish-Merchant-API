...
public class OrderAlreadyFulfilledException extends ServiceResponseException{

    public OrderAlreadyFulfilledException(String message, WishRequest request, WishResponse response) {
