...
public class MissingFieldException extends ServiceResponseException{

    public MissingFieldException(String message, WishRequest request, WishResponse response) {
